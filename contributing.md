# Contributing to cordlr-help

First and foremost, thank you! We appreciate that you want to contribute to cordlr-help, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for cordlr-help**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for cordlr-help:

- star the [project](https://github.com/seanc/cordlr-help)
- tweet your support for cordlr-help
...
- **version**: please note the version of cordlr-help are you using
...
[so]: http://stackoverflow.com/questions/tagged/cordlr-help